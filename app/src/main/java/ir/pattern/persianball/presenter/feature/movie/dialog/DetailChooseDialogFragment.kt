...
import ir.pattern.persianball.presenter.feature.home.HomeDataAdapter
import ir.pattern.persianball.presenter.feature.movie.MovieDetailViewModel
import kotlinx.coroutines.flow.flowOf
import kotlinx.coroutines.launch

@AndroidEntryPoint
class DetailChooseDialogFragment(val title:String, val list: List<RecyclerItem>) :
    DialogFragment() {

    lateinit var binding: CourseChosenDialogBinding
    private val dialogViewModel: MovieDetailViewModel by viewModels({ requireParentFragment() })
